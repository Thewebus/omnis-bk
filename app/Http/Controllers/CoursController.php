...
class CoursController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('informatique.schedule.index', compact('classes'));
    }
    ...
    public function create($id)
    {
        $classe = Classe::findOrFail($id);
        $salles = Salle::orderBy('nom', 'ASC')->get();
        return view('informatique.schedule.create', compact('classe', 'salles'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (is_null($matiereProfesseur)) {
            ...
            return redirect()->route('admin.emploi-du-temps.maquette', $classe->id);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (is_null($matiereProfesseur)) {
            flashy()->error('Cette matière n\'est pas affectée à un professseur !');
            return redirect()->route('admin.emploi-du-temps.maquette', $request->classe);
        }
    ...
    public function maquette(ScheduleService $scheduleService, $id) {
        ...
        return view('informatique.schedule.maquette', compact('jours', 'donneesCalendrier', 'classe'));
    }
