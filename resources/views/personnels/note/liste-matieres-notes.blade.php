							...
							<table class="display" id="basic-2">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="{{ route('admin.scolarite-notes-matiere', $matiere->id) }}" class="btn btn-success mt-3"><i class="fa fa-eye"></i></a>
												...
												<div class="modal-dialog modal-dialog-centered" role="document">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<form action="{{ route('admin.scolarite-suppression-notes', $matiere->id) }}" method="POST">
																@method('DELETE')
																@csrf
