                ...
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-md-3"></div>
                            <div class="col-md-3"></div>
                            <div class="col-md-3"> <a href="{{ route('admin.scolarite-inscritpion-modif-form', $inscription->etudiant->id) }}" class="btn btn-warning"><i class="fa fa-edit"></i> Modifié les informations</a></div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
