        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.scolarite-inscritpion-modif-form-post', $etudiant->id) }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="row">
							...
							<div class="row g-3 mb-3">
								<div class="col-md-4">
                                    ...
                                    <input class="form-control @error('nom_complet') is-invalid @enderror" id="nom_complet" value="{{ old('nom_complet') ?? $etudiant->fullname }}" name="nom_complet" type="text" placeholder="Nom & Prénom" />
                                    @error('nom_complet')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control @error('date_naissance') is-invalid @enderror" id="date_naissance" value="{{ old('date_naissance') ?? $etudiant->date_naissance }}" name="date_naissance" type="date" placeholder="Date de naissance" />
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control @error('lieu_naissance') is-invalid @enderror" id="lieu_naissance" value="{{ old('lieu_naissance') ?? $etudiant->lieu_naissance }}" name="lieu_naissance" type="text" placeholder="Lieu de naissance" />
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control @error('nationalite') is-invalid @enderror" id="nationalite" value="{{ old('nationalite') ?? $etudiant->nationalite }}" name="nationalite" type="text" placeholder="Nationalité" />
                                    @error('nationalite')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control @error('domicile') is-invalid @enderror" id="domicile" value="{{ old('domicile') ?? $etudiant->domicile }}" name="domicile" type="text" placeholder="Domicile" />
                                    @error('domicile')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control @error('numero') is-invalid @enderror" id="numero" value="{{ old('numero') ?? $etudiant->numero_etudiant }}" name="numero" type="number" placeholder="Contact" />
                                    @error('numero')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" id="email" value="{{ old('email') ?? $etudiant->email }}" name="email" type="text" placeholder="Email" />
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control @error('etablissement_origine') is-invalid @enderror" id="etablissement_origine" value="{{ old('etablissement_origine') ?? $etudiant->etablissement_origine }}" name="etablissement_origine" type="text" placeholder="Etablissement d'origine" />
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control @error('adresse_geographique') is-invalid @enderror" id="adresse_geographique" value="{{ old('adresse_geographique') ?? $etudiant->adresse_geographique }}" name="adresse_geographique" type="text" placeholder="Adresse Géographique" />
                                    @error('adresse_geographique')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label" for="niveau_etude">Niveau d'étude <span style="color: red">*</span></label>
                                    <input class="form-control @error('niveau_etude') is-invalid @enderror" id="niveau_etude" value="{{ old('niveau_etude') ?? $etudiant->niveau_etude }}" name="niveau_etude" type="text" placeholder="Niveau d'étude" />
                                    @error('niveau_etude')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control @error('serie_bac') is-invalid @enderror" id="serie_bac" value="{{ old('serie_bac') ?? $etudiant->serie_bac }}" name="serie_bac" type="text" placeholder="Série BAC" />
                                    @error('serie_bac')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div> 
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="form-group m-t-10 m-checkbox-inline mb-0 custom-radio-ml">
                                        <div class="radio radio-primary">
                                            <input class="radio_animated" id="affecte" type="radio" name="statut" value="affecté" {{ $etudiant->statut == 'affecté' ? 'checked' : '' }} >
                                            <label class="mb-0" for="affecte">Affecté</label>
                                        </div>
                                        <div class="radio radio-primary">
                                            <input class="radio_animated" id="non-affecte" type="radio" name="statut" value="non affecté" {{ $etudiant->statut == 'non affecté' ? 'checked' : '' }}>
                                            <label class="mb-0" for="non-affecte">Non Affecté</label>
                                        </div>
                                        <div class="radio radio-primary">
                                            <input class="radio_animated" id="reaffecte" type="radio" name="statut" value="réaffecté" {{ $etudiant->statut == 'non affecté' ? 'réaffecté' : '' }} >
                                ...
                                {{-- <div class="col-md-3">
                                    ...
                                    <input class="form-control @error('faculte') is-invalid @enderror" id="faculte" value="{{ old('faculte') }}" name="faculte" type="text" placeholder="Faculté" />
                                    @error('faculte')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div> --}}
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control @error('date_premiere_entree') is-invalid @enderror" id="date_premiere_entree" value="{{ old('date_premiere_entree') ?? $etudiant->premier_entree_ua }}" name="date_premiere_entree" type="number" placeholder="Date de la 1er rentrée à l'université" />
                            ...
                            <div class="row mb-3 g-3">
                                <div class="col-md-5 mb-3">
                                    ...
                                    <div class="form-group m-t-10 m-checkbox-inline mb-0 custom-radio-ml">
                                        <div class="radio radio-primary">
                                            <input class="radio_animated" id="pere" type="radio" name="responsable_legal" value="pere"  {{ $etudiant->responsable_legal == 'pere' ? 'checked' : '' }}>
                                            <label class="mb-0" for="pere">Père</label>
                                        </div>
                                        <div class="radio radio-primary">
                                            <input class="radio_animated" id="mere" type="radio" name="responsable_legal" value="mere" {{ $etudiant->responsable_legal == 'mere' ? 'checked' : '' }}>
                                            <label class="mb-0" for="mere">Mère</label>
                                        </div>
                                        <div class="radio radio-primary">
                                            <input class="radio_animated" id="vivant seul" type="radio" name="responsable_legal" value="vivant seul" {{ $etudiant->responsable_legal == 'vivant seul' ? 'checked' : '' }}>
                                            <label class="mb-0" for="vivant seul">Vivant seul</label>
                                        </div>
                                        <div class="radio radio-primary">
                                            <input class="radio_animated" id="autre" type="radio" name="responsable_legal" value="autre" {{ $etudiant->responsable_legal == 'autre' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control @error('responsable_legal_precision') is-invalid @enderror" id="responsable_legal_precision" value="{{ old('responsable_legal_precision') ?? $etudiant->responsable_legal_precision }}" name="responsable_legal_precision" type="text" placeholder="Précision autre" />
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control @error('responsable_legal_fullname') is-invalid @enderror" id="responsable_legal_fullname" value="{{ old('responsable_legal_fullname') ?? $etudiant->responsable_legal_fullname  }}" name="responsable_legal_fullname" type="text" placeholder="Nom & Prénom" />
                            ...
                            <div class="row mb-3 g-3">
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control @error('responsable_legal_profession') is-invalid @enderror" id="responsable_legal_profession" value="{{ old('responsable_legal_profession') ?? $etudiant->responsable_legal_profession }}" name="responsable_legal_profession" type="text" placeholder="Profession" />
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control @error('responsable_legal_adresse') is-invalid @enderror" id="responsable_legal_adresse" value="{{ old('responsable_legal_adresse') ?? $etudiant->responsable_legal_adresse }}" name="responsable_legal_adresse" type="text" placeholder="Adresse" />
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control @error('responsable_legal_domicile') is-invalid @enderror" id="responsable_legal_domicile" value="{{ old('responsable_legal_domicile') ?? $etudiant->responsable_legal_domicile }}" name="responsable_legal_domicile" type="text" placeholder="Domicile" />
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control @error('responsable_legal_numero') is-invalid @enderror" id="responsable_legal_numero" value="{{ old('responsable_legal_numero') ?? $etudiant->responsable_legal_numero }}" name="responsable_legal_numero" type="text" placeholder="Téléphone" />
