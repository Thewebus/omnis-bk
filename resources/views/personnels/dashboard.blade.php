...
<li class="breadcrumb-item active">Tableau de bord du personnel</li>
@endpush
                        ...
                        <div class="bg-primary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    <span class="m-0">Filieres</span>
                                    <h4 class="mb-0 counter">{{ $nbrFilieres }}</h4>
                        ...
                        <div class="bg-secondary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    ...
                                    <h4 class="mb-0 counter">{{ $nbrClasses }}</h4>
                    ...
                    <div class="card o-hidden border-0">
                        <div class="bg-primary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    <span class="m-0">Instituts</span>
                                    <h4 class="mb-0 counter">{{ $nbrInstituts }}</h4>
                        ...
                        <div class="bg-secondary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    ...
                                    <h4 class="mb-0 counter">{{ $nbrProfs }}</h4>
                                    <i class="icon-bg" data-feather="shopping-bag"></i>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-primary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    ...
                                    <h4 class="mb-0 counter">{{ $nbrEtudiants }}</h4>
