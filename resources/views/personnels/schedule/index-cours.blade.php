                                            ...
                                            <div class="modal fade" id="changeModal{{ $cours->id }}" tabindex="-1" role="dialog" aria-labelledby="changeModal{{ $cours->id }}" aria-hidden="true">
												<div class="modal-dialog modal-dialog-centered" role="document">
													<div class="modal-content">
                                                        ...
                                                        <form action="{{ route('admin.scolarite.emploi-du-temps.update', $cours->id) }}" method="POST">
															@method('PUT')
                                                            @csrf
												...
												<div class="modal-dialog modal-dialog-centered" role="document">
													<div class="modal-content">
														...
														<div class="modal-footer">
															...
															<form action="{{ route('admin.scolarite.emploi-du-temps.destroy', $cours->id) }}" method="POST">
																@method('DELETE')
																@csrf
