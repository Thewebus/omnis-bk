        ...
        <div class="row">
            <div class="col-sm-6 col-xl-3 col-lg-6">
                <div class="card o-hidden border-0">
                    <a href="{{ route('admin.details-scolarite-classe') }}">
                        <div class="bg-primary b-r-4 card-body">
                            <div class="media static-top-widget">
                                <div class="align-self-center text-center"><i data-feather="shopping-bag"></i></div>
                                <div class="media-body">
                                    <span class="m-0">Total Scolarité (Fr CFA)</span>
                                    <h4 class="mb-0 counter">{{ $dataDash['sommeTotale'] }}</h4>
            ...
            <div class="col-sm-6 col-xl-3 col-lg-6">
                <div class="card o-hidden border-0">
                    <a href="{{ route('admin.details-scolarite-payee-classe') }}">
                        <div class="bg-secondary b-r-4 card-body">
                            <div class="media static-top-widget">
                                <div class="align-self-center text-center"><i data-feather="shopping-bag"></i></div>
                                <div class="media-body">
                                    <span class="m-0">Scolarité Payé (Fr CFA)</span>
                                    <h4 class="mb-0 counter">{{ $dataDash['sommePaye'] }}</h4>
                                    <i class="icon-bg" data-feather="shopping-bag"></i>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-sm-6 col-xl-3 col-lg-6">
                <div class="card o-hidden border-0">
                    <a href="{{ route('admin.details-scolarite-restante-classe') }}">
                        <div class="bg-danger b-r-4 card-body">
                            <div class="media static-top-widget">
                                <div class="align-self-center text-center"><i data-feather="shopping-bag"></i></div>
                                <div class="media-body">
                                    <span class="m-0">Scolarité Restant (Fr CFA)</span>
                                    <h4 class="mb-0 counter">{{ $dataDash['sommeRestante'] }}</h4>
                                    <i class="icon-bg" data-feather="shopping-bag"></i>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card o-hidden border-0">
                    <div class="bg-warning b-r-4 card-body">
                        <div class="media static-top-widget">
                            ...
                            <div class="media-body">
                                <span class="m-0">Nbr. Etudiants</span>
                                <h4 class="mb-0 counter">{{ $dataDash['nbrEtudiants'] }}</h4>
                ...
                <div class="card o-hidden border-0">
                    <div class="bg-success b-r-4 card-body">
                        <div class="media static-top-widget">
                            <div class="align-self-center text-center"><i data-feather="shopping-bag"></i></div>
                            <div class="media-body">
                                <span class="m-0">Total paie Prof (Fr CFA)</span>
                                <h4 class="mb-0 counter">{{ $dataDash['depenseProfesseur'] }}</h4>
                                <i class="icon-bg" data-feather="shopping-bag"></i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card o-hidden border-0">
                    <div class="bg-secondary b-r-4 card-body">
                        <div class="media static-top-widget">
                            ...
                            <div class="media-body">
                                <span class="m-0">Total vol. Horaire</span>
                                <h4 class="mb-0 counter">{{ $dataDash['TotalVolumeHoraire'] }}</h4>
                ...
                <div class="card o-hidden border-0">
                    <div class="bg-danger b-r-4 card-body">
                        <div class="media static-top-widget">
                            <div class="align-self-center text-center"><i data-feather="clock"></i></div>
                            <div class="media-body">
                                <span class="m-0">Total vol. Horaire BTS</span>
                                <h4 class="mb-0 counter">{{ $dataDash['volumeHoraireBTS'] }}</h4>
                                <i class="icon-bg" data-feather="clock"></i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card o-hidden border-0">
                    <div class="bg-warning b-r-4 card-body">
                        <div class="media static-top-widget">
                            <div class="align-self-center text-center"><i data-feather="shopping-bag"></i></div>
                            <div class="media-body">
                                <span class="m-0">Total prix BTS (Fr CFA)</span>
                                <h4 class="mb-0 counter">{{ $dataDash['prixHoraireBTS'] }}</h4>
                                <i class="icon-bg" data-feather="shopping-bag"></i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card o-hidden border-0">
                    <div class="bg-success b-r-4 card-body">
                        <div class="media static-top-widget">
                            <div class="align-self-center text-center"><i data-feather="clock"></i></div>
                            <div class="media-body">
                                <span class="m-0">Total vol. Horaire LICENCE</span>
                                <h4 class="mb-0 counter">{{ $dataDash['volumeHoraireLicence'] }}</h4>
                                <i class="icon-bg" data-feather="clock"></i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card o-hidden border-0">
                    <div class="bg-primary b-r-4 card-body">
                        <div class="media static-top-widget">
                            <div class="align-self-center text-center"><i data-feather="shopping-bag"></i></div>
                            <div class="media-body">
                                <span class="m-0">Total prix LICENCE (Fr CFA)</span>
                                <h4 class="mb-0 counter">{{ $dataDash['prixHoraireLicence'] }}</h4>
                                <i class="icon-bg" data-feather="shopping-bag"></i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card o-hidden border-0">
                    <div class="bg-secondary b-r-4 card-body">
                        <div class="media static-top-widget">
                            <div class="align-self-center text-center"><i data-feather="clock"></i></div>
                            <div class="media-body">
                                <span class="m-0">Total vol. Horaire MASTER</span>
                                <h4 class="mb-0 counter">{{ $dataDash['volumeHoraireMaster'] }}</h4>
                                <i class="icon-bg" data-feather="clock"></i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card o-hidden border-0">
                    <div class="bg-danger b-r-4 card-body">
                        <div class="media static-top-widget">
                            <div class="align-self-center text-center"><i data-feather="shopping-bag"></i></div>
                            <div class="media-body">
                                <span class="m-0">Total prix MASTER (Fr CFA)</span>
                                <h4 class="mb-0 counter">{{ $dataDash['prixHoraireMaster'] }}</h4>
                                <i class="icon-bg" data-feather="shopping-bag"></i>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card o-hidden border-0">
                    <div class="bg-warning b-r-4 card-body">
                        <div class="media static-top-widget">
                            <div class="align-self-center text-center"><i data-feather="user-plus"></i></div>
                            <div class="media-body">
                                <span class="m-0">Nbr. Professeurs</span>
                                <h4 class="mb-0 counter">{{ $dataDash['nombreProfeseurs'] }}</h4>
                                <i class="icon-bg" data-feather="user-plus"></i>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-12 xl-100 box-col-12">
                <div class="card">
                    <div class="cal-date-widget card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <p class="f-16">Taux de recouvrement scolarité ({{ round($dataDash['pourcentage'], 2) }}%)</p>
                                <div class="progress">
                                    <div class="progress-bar-animated progress-bar-striped bg-info" role="progressbar" style="width: {{ $dataDash['pourcentage'] }}%" aria-valuenow="{{ $dataDash['pourcentage'] }}" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
