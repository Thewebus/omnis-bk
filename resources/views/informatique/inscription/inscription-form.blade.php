...
@section('content')
    @component('components.informatique.breadcrumb')
        ...
        @endslot
        <li class="breadcrumb-item active">Formulaire d'Inscription</li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.inscription-etudiant-post') }}" enctype="multipart/form-data" method="POST" novalidate>
                            @csrf
                            <div class="row">
							...
							<div class="row g-3 mb-3">
								<div class="col-md-4">
                                    ...
                                    <input class="form-control @error('nom_complet') is-invalid @enderror" id="nom_complet" value="{{ old('nom_complet') }}" name="nom_complet" type="text" placeholder="Nom & Prénom" />
                                    @error('nom_complet')
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control @error('numero') is-invalid @enderror" id="numero" value="{{ old('numero') }}" name="numero" type="number" placeholder="Contact" />
                                    @error('numero')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" id="email" value="{{ old('email') }}" name="email" type="text" placeholder="Email" />
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3 g-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control @error('id_permanent') is-invalid @enderror" id="id_permanent" value="{{ old('id_permanent') }}" name="id_permanent" type="text" placeholder="ID Permanent" />
                                    @error('id_permanent')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3 g-3">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control @error('numero_table_bac') is-invalid @enderror" id="numero_table_bac" value="{{ old('numero_table_bac') }}" name="numero_table_bac" type="text" placeholder="Numéro table BAC" />
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control @error('code_ep') is-invalid @enderror" id="code_ep" value="{{ old('code_ep') }}" name="code_ep" type="text" placeholder="Code EP" />
                                    @error('code_ep')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control @error('emargement') is-invalid @enderror" id="emargement" value="{{ old('emargement') }}" name="emargement" type="text" placeholder="Emargement" />
                                    @error('emargement')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
