				...
				<div class="card">
                    ...
                    <div class="card-block row">
                        <div class="col-sm-12 col-lg-12 col-xl-12">
							<form action="{{ route('admin.post-notes-partiel', $matiere->id) }}" method="post">
								@csrf
										...
										<tbody>
											...
											@foreach ($dataNotes as $dataNote)
												<tr>
													...
													<td>
														<input class="form-control @error('partiel_session_1') is-invalid @enderror" name="{{ $dataNote['nom_etudiant']->id }}" value="{{ old('partiel_session_1') ?? $dataNote['partiel_session_1'] }}" type="number" step="0.01" placeholder="0" />
