...
<body>
	<div class="container">
		...
		<div class="semestre-1">
			...
			<span class="etudiant">Liste des étudiants ajournés</span>
		</div>
		...
		<table class="table">
			<thead class="bg-primary">
				<tr>
					...
					<th class="align-center">Dec. finale</th>
			</thead>
			<tbody>
				@foreach ($dataNotes as $dataNote)
					<tr>
						...
						<td class="align-center">{{ $dataNote['nom_etudiant']->matricule_etudiant }}</td>
						<td class="align-center">{{ $dataNote['decision_finale'] }}</td>
					</tr>
				@endforeach
			</tbody>
		</table>
