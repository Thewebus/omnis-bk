				...
				<div class="card">
					...
					<div class="card-block row">
						...
						<div class="col-sm-12 col-lg-12 col-xl-12 text-center m-3">
							<a href="{{ route('admin.emploi-du-temps.create', $classe->id) }}" class="btn btn-primary"><i class="fa fa-plus"></i> Nouveau cours</a>
							<a href="{{ route('admin.emploi-du-temps.index-cours', $classe->id) }}" class="btn btn-warning"><i class="fa fa-list"></i> Liste des cours</a>
						</div>
					</div>
				</div>
			</div>
