...
@section('title', 'Tableau de bord informaticien')
                            ...
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body">
                                        <span class="m-0">Facultés</span>
                                        <h4 class="mb-0 counter">{{ $arrayData['nbrFilieres'] }}</h4>
                            ...
                            <div class="bg-secondary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h4 class="mb-0 counter">{{ $arrayData['nbrClasses'] }}</h4>
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-secondary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="align-self-center text-center"><i data-feather="shopping-bag"></i></div>
                                    <div class="media-body">
                                        <span class="m-0">Professeurs</span>
                                        <h4 class="mb-0 counter">{{ $arrayData['nbrProfs'] }}</h4>
                                        <i class="icon-bg" data-feather="shopping-bag"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h4 class="mb-0 counter">{{ $arrayData['nbrEtudiants'] }}</h4>
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="align-self-center text-center"><i data-feather="user-plus"></i></div>
                                    <div class="media-body">
                                        <span class="m-0">Personnels</span>
                                        <h4 class="mb-0 counter">{{ $arrayData['nbrPersonnels'] }}</h4>
                                        <i class="icon-bg" data-feather="user-plus"></i>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="align-self-center text-center"><i data-feather="user-plus"></i></div>
                                    <div class="media-body">
                                        <span class="m-0">Salles</span>
                                        <h4 class="mb-0 counter">{{ $arrayData['salle'] }}</h4>
                                        <i class="icon-bg" data-feather="user-plus"></i>
                                    </div>
                                </div>
                            </div>
