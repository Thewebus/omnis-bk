			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header">
						<span style="font-size: 1rem">Litse des matières pour consultation liste de présence</span>
					</div>
				</div>
			</div>
			@foreach ($matiereProfesseurs as $matiereProfesseur)
				...
				@if (!is_null($matiereProfesseur->matiere))
					<div class="col-sm-6 col-xl-3 col-lg-6">
						<a href="{{ route('prof.consultation-liste-presence', $matiereProfesseur->matiere->id) }}">
