...
<li class="breadcrumb-item active">Tableau de bord du professeur</li>
@endpush --}}
                            ...
                            <div class="bg-primary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body">
                                        <span class="m-0">Modules</span>
                                        <h4 class="mb-0 counter">{{ Auth::user()->matieres->count() }}</h4>
                        ...
                        <div class="card o-hidden border-0">
                            <div class="bg-secondary b-r-4 card-body">
                                <div class="media static-top-widget">
                                    ...
                                    <div class="media-body">
                                        <span class="m-0">Total tx Horaire</span>
                                        <h4 class="mb-0 counter">{{ array_sum(array_column($progressions, 'volume_horaire')) }}</h4>
                            ...
                            <div class="card o-hidden border-0">
                                <div class="bg-primary b-r-4 card-body">
                                    <div class="media static-top-widget">
                                        ...
                                        <div class="media-body">
                                            <span class="m-0">Total tx Honnaire</span>
                                            <h4 class="mb-0 counter">{{ array_sum(array_column($progressions, 'honoraire')) }}</h4>
                                ...
                                <div class="cal-date-widget card-body">
                                    <div class="row">
                                        ...
                                        {{-- <div class="col-md-9 mt-2">
                                            Honoraire pour cette matière : <strong>{{ $progression['honoraire'] }} CFA</strong> 
                                        </div>
                                        <div class="col-md-3 mt-2">
                                            Cours : <strong>{{ strtoupper($progression['systeme']) }}</strong>
                                        </div> --}}
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-12 col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="cal-date-widget card-body">
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        <h4>Bienvenue sur notre plate forme de gestion des professeurs.</h4>
                                        <p class="f-16">
                                            Rendez vous dans la partie <b>enregistrement</b>, puis remplissez le formulaire d'enrégistrement.
                                        </p>
                                    </div>
                                </div>
                            </div>
