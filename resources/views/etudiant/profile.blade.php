...
@section('content')
	...
	<div class="container-fluid">
        <div class="email-wrap bookmark-wrap">
            <div class="row">
                <div class="col-xl-3">
                    <div class="email-sidebar"><a class="btn btn-primary email-aside-toggle" href="javascript:void(0)">Voir le profil</a>
                            ...
                            <div class="card">
                                ...
                                <div class="email-app-sidebar left-bookmark">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>{{ Auth::user()->email ?? 'Pas d\'email ' }}</p>
                                    </div>
                                    </div>
                                                    ...
                                                    <form method="POST" action="#">
                                                        ...
                                                        <div class="row g-3 mb-3">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input class="form-control @error('nom_prenoms') is-invalid @enderror" disabled name="nom_prenoms" id="nom_prenoms" value="{{ old('nom_prenoms') ?? Auth::user()->fullname }}" type="text"/>
                                                                @error('nom_prenoms')
                                                        ...
                                                        <div class="row g-3 mb-3">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input class="form-control @error('numero') is-invalid @enderror" disabled value="{{ old('numero') ?? Auth::user()->numero_etudiant }}" id="numero" name="numero" type="text"/>
                                                                @error('numero')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input class="form-control" disabled value="{{ Auth::user()->email ?? 'NEANT' }}" type="text"/>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="details-bookmark">
                                                    ...
                                                    <form method="POST" action="{{ route('user.change-password') }}">
                                                        ...
                                                        <div class="row g-3 mb-3">
                                                            <div class="col-md-6">
                                                                <label class="form-label" for="numero">Numéro</label>
                                                                <input class="form-control @error('numero') is-invalid @enderror" id="numero" name="numero" value="{{ old('numero') ?? Auth::user()->numero_etudiant }}" placeholder="{{ Auth::user()->numero_etudiant ?? 'numero' }}" type="text"/>
                                                                @error('numero')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
