    ...
    <div class="container-fluid">
        <div class="row">
            @isset($dataProgressionCours)
                        ...
                        <div class="bg-primary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    <span class="m-0">Matières</span>
                                    <h4 class="mb-0 counter">{{ $dataDash['matiere'] }}</h4>
                    ...
                    <div class="card o-hidden border-0">
                        <div class="bg-secondary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    <span class="m-0">Heure d'absence</span>
                                    <h4 class="mb-0 counter">{{ $dataDash['heure_absence'] }}</h4>
                    ...
                    <div class="card o-hidden border-0">
                        <div class="bg-primary b-r-4 card-body">
                            <div class="media static-top-widget">
                                ...
                                <div class="media-body">
                                    <span class="m-0">Restant (Fr CFA)</span>
                ...
                <div class="col-xl-12 xl-100 box-col-12">
                    <div class="card">
                        <div class="cal-date-widget card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="f-16">Barre de progression de la scolarité ({{ round($dataDash['scolarite_pourcentage'], 2) }}%)</p>
                                    <div class="progress">
                                        <div class="progress-bar-animated progress-bar-striped bg-info" role="progressbar" style="width: {{ $dataDash['scolarite_pourcentage'] }}%" aria-valuenow="{{ $dataDash['scolarite_pourcentage'] }}" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <div class="col-md-4 mt-3">Scolarité : {{ $dataDash['scolarite_montant'] }}</div>
                                <div class="col-md-4 mt-3"> Payé : {{ $dataDash['scolarite_payee'] }}</div>
                                <div class="col-md-4 mt-3">Reste : {{ $dataDash['scolarite_rest'] }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="cal-date-widget card-body">
                            <div class="row">
                                ...
                                @if (count($dataNotes) == 0)
                                    <div class="col-md-12 text-center">
                                        <h6>Aucune note pour le moment</h6>
                                    </div>
                                @else
                                    @foreach ($dataNotes as $dataNote)
                                        <div class="col-md-3 mt-3"><h6> {{ $dataNote['nom_matiere'] }} : {{ $dataNote['note'] }}/20</h6></div>
                                    @endforeach
                                @endif
                            </div>
                        </div>
                ...
                @if (count($dataProgressionCours) == 0)
                    <div class="col-sm-12 col-xl-12 col-lg-12 text-center mb-3">
                        <h6>Aucun cours débutée pour le moment.</h6>
                    </div>
                @else
                    @foreach ($dataProgressionCours as $dataProgressionCour)
                        <div class="col-sm-6 col-xl-6 col-lg-6">
                            <div class="card">
                                <div class="cal-date-widget card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p class="f-16">{{ $dataProgressionCour['nom_matiere'] }} - {{ round($dataProgressionCour['pourcentage'], 2) }}% ({{ $dataProgressionCour['progression'] }}h / {{ $dataProgressionCour['volume_horaire'] }}h)</p>
                                            <div class="progress">
                                                <div class="progress-bar-animated progress-bar-striped bg-info" role="progressbar" style="width: {{ round($dataProgressionCour['pourcentage'], 2) }}%" aria-valuenow="{{ round($dataProgressionCour['pourcentage'], 2) }}" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-8 mt-2">
                                            Professeur : {{ $dataProgressionCour['nom_professeur'] }} 
                                        </div>
                                        <div class="col-md-4 mt-2">Status : <span class="badge rounded-pill {{ $dataProgressionCour['statut'] !== 'en_cours' ? 'badge-warning' : 'badge-primary' }} text-dark">{{ $dataProgressionCour['statut'] }}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-12 col-xl-12 col-lg-12">
                    <div class="card">
                        <div class="cal-date-widget card-body">
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <h4>Bienvenue sur notre plate forme de gestion d'étudiant.</h4>
                                    <p class="f-16">
                                        Rendez vous dans la partie <b>Inscription</b>, puis remplissez le formulaire d'inscription.
                                    </p>
                                </div>
                            </div>
                        </div>
