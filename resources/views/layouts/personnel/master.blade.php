...
<html lang="en">
    <head>
        ...
        <!-- Font Awesome-->
        @includeIf('layouts.personnel.partials.css')
    </head>
  <body>
    <!-- Loader starts-->
    ...
    <div class="page-wrapper compact-sidebar" id="pageWrapper">
      <!-- Page Header Start-->
      @includeIf('layouts.personnel.partials.header')
      <!-- Page Header Ends -->
      <!-- Page Body Start-->
      <div class="page-body-wrapper sidebar-icon">
        <!-- Page Sidebar Start-->
        @includeIf('layouts.personnel.partials.sidebar')
        <!-- Page Sidebar Ends-->
        <div class="page-body">
    ...
    <!-- latest jquery-->
    @includeIf('layouts.personnel.partials.js')
