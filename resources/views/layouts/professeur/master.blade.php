...
<html lang="en">
    <head>
        ...
        <!-- Font Awesome-->
        @includeIf('layouts.professeur.partials.css')
    </head>
  <body>
    <!-- Loader starts-->
    ...
    <div class="page-wrapper compact-sidebar" id="pageWrapper">
      <!-- Page Header Start-->
      @includeIf('layouts.professeur.partials.header')
      <!-- Page Header Ends -->
      <!-- Page Body Start-->
      <div class="page-body-wrapper sidebar-icon">
        <!-- Page Sidebar Start-->
        @includeIf('layouts.professeur.partials.sidebar')
        <!-- Page Sidebar Ends-->
        <div class="page-body">
    ...
    <!-- latest jquery-->
    @includeIf('layouts.professeur.partials.js')
