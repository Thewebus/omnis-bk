<div class="page-main-header">
    <div class="main-header-right row m-0">
        <div class="main-header-left">
            <div class="logo-wrapper"><a href="{{ route('user.dashboard-etudiant') }}"><img class="img-fluid" src="{{asset(env('LOGO_PATH'))}}" alt=""></a></div>
            <div class="dark-logo-wrapper"><a href="{{ route('user.dashboard-etudiant') }}"><img class="img-fluid" src="{{asset(env('LOGO_PATH'))}}" alt=""></a></div>
