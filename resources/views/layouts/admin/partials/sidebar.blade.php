<header class="main-nav">
    <div class="sidebar-user text-center">
        ...
        <a href="#"> <h6 class="mt-3 f-14 f-w-600">Welcome Another</h6></a>
        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav" style="display:;" href="#"><i data-feather="file-text"></i><span>Tableau de bord</span></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav" style="display:;" href="#"><i data-feather="file-text"></i><span>Inscription Test</span></a>
                    </li>
                    {{-- <li class="dropdown">
                        <a class="nav-link menu-title {{ prefixActive('/dashboard') }}" href="javascript:void(0)"><i data-feather="home"></i><span>Tableau de bord</span></a>
                        <ul class="nav-submenu menu-content" style="display: {{ prefixBlock('/dashboard') }};">
                            <li><a href="{{route('index')}}" class="{{routeActive('index')}}">Inscription test</a></li>
                        </ul>
                    </li> --}}
                    <li class="dropdown">
